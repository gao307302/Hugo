...
//
//    private static final Pair<String, String> datePair = new Pair<>("年度", "季度");
//
//    private static final String tableName = "t_market_overview_year";
//    /**
//     * 生成sql语句
//     *
//     * @param fileName
...
//        // TODO
//
//        XSSFSheet sheet = xssfWorkbook.getSheetAt(FilePosYearCity.sheetNumInsert);
...
//        // 第一行是表头
//        for (int row = FilePosYearCity.rowNumInsert; row <= maxRow; row++) {
...
//                    if (CommonUtils.nullStringCheck(value)) {
...
//                    .append(" data_type = ").append(1).append(",")
...
//        String extra;
//        if(FilePosYearCity.newQuarter) {
//            sb.append("UPDATE ").append(tableName)
//                    .append(" SET date_order = 0 WHERE date_order = 2;\n");
//            sb.append("UPDATE ").append(tableName)
//                    .append(" SET date_order = 2 WHERE date_order = 1;\n");
//            sb.append("UPDATE ").append(tableName)
//                    .append(" w SET w.date_order = 1 WHERE w.date_year = '").append(FilePosYearCity.year).append("'")
//                    .append(";\n");
//        }
...
//        HashMap<String, Pair<String, Integer>> sqlColumnTypeMap = InitUtils.getSqlColumnType(FilePosYearCity.sqlColumnName);
//        List<String> list = getSqlList(FilePosYearCity.updatedFile, sqlColumnTypeMap);
//        System.out.println(list.size());
//        for (String s :
//                list) {
//            InitUtils.saveAsFileWriter(s, FilePosYearCity.outputFileInsert);
//        }
//        String extra;
//        StringBuilder sb = new StringBuilder();
//        extra = getString(sb);
//        InitUtils.saveAsFileWriter(extra, FilePosYearCity.outputFileInsert);
//
//    }
//
//}

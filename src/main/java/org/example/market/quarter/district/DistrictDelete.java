...
//        List<String> list = initUtils.getDistrictQuarterDeleteSqlList(filePosQuarterDistrict, districtInsert);
//        System.out.println(list.size());
//        for (String s :
//                list) {
//            InitUtils.saveAsFileWriter(s, filePosQuarterDistrict.outputFileDelete);
//        }
//    }
//}

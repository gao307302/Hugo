...
//        FilePos filePosYearDistrict = new FilePosQuarterCity();
//        InitUtils initUtils = new InitUtils();
//        HashMap<String, Pair<String, Integer>> sqlColumnTypeMap = InitUtils.getSqlColumnType(filePosYearDistrict.sqlColumnName);
//        List<String> list = cityInsert.getSqlList(filePosYearDistrict.updatedFile, sqlColumnTypeMap);
